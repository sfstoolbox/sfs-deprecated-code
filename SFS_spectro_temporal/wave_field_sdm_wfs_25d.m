function [x,y,P] = wave_field_sdm_wfs_25d(X,Y,xs,ys,L,f,src,conf)
%WAVE_FIELD_SDM_WFS_25D simulates the wave field of a given source for 25D SDM
%   Usage: [x,y,P] = wave_field_sdm_wfs_25d(X,Y,xs,ys,L,f,src,conf)
%          [x,y,P] = wave_field_sdm_wfs_25d(X,Y,xs,ys,L,f,src)
%
%   Input parameters:
...
%
%   WAVE_FIELD_SDM_WFS_25D(X,Y,xs,ys,L,f,src,conf) simulates a wave field of
...
%   field, you can use the wave_field_sdm_wfs_25d_approx function instead.
%
%   References:
